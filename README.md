...
📖 **Deep dives:**
- [Stop re-explaining your project to Claude Code every session](https://dev.to/manja316/stop-re-explaining-your-project-to-claude-code-every-session-648) — the *why* behind the index rule and how the memory types map to real workflows.
